...
exports.seedInitailProducts = exports.getAllProducts = void 0;
const productModel_1 = require("../models/productModel");
// get all  products
const getAllProducts = async () => {
    return await productModel_1.productModel.find();
};
exports.getAllProducts = getAllProducts;
// insert products 
const seedInitailProducts = async () => {
    // product  list 
    try {
        const products = [
            {
        ...
        const existingProducts = await (0, exports.getAllProducts)();
...
exports.seedInitailProducts = seedInitailProducts;
